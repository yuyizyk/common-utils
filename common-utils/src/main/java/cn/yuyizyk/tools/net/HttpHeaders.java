...
public final class HttpHeaders {
	...
	/**
	 * The HTTP <a href="https://tools.ietf.org/html/rfc7239">{@code Forwarded}</a>
	 * header field name.
	 *
	 * @since 20.0
	 */
	...
	/**
	 * The HTTP <a href=
	 * "https://tools.ietf.org/html/rfc7540#section-3.2.1">{@code HTTP2-Settings}
	 * </a> header field name.
	 *
	 * @since 24.0
	 */
	...
	/**
	 * The HTTP
	 * <a href="https://www.w3.org/TR/service-workers/#update-algorithm">{@code
	...
	/**
	 * The HTTP nonstandard {@code X-Content-Security-Policy} header field name. It
	 * was introduced in <a href="https://www.w3.org/TR/2011/WD-CSP-20111129/">CSP
	 * v.1</a> and used by the Firefox until version 23 and the Internet Explorer
	 * version 10. Please, use {@link #CONTENT_SECURITY_POLICY} to pass the CSP.
	 *
	 * @since 20.0
	 */
	 ...
	 * <a href="https://www.w3.org/TR/2011/WD-CSP-20111129/">CSP v.1</a> and used by
	...
	/**
	 * The HTTP {@code Refresh} header field name. Non-standard header supported by
	 * most browsers.
	 */
	...
	/**
	 * The HTTP
	 * <a href="https://www.w3.org/TR/server-timing/">{@code Server-Timing}</a>
	 * header field name.
	 *
	 * @since 23.6
	 */
	...
	/**
	 * The HTTP <a href="https://goo.gl/VKpXxa">{@code X-Download-Options}</a>
	 * header field name.
	 *
	 * <p>
	 * When the new X-Download-Options header is present with the value
	 * {@code noopen}, the user is prevented from opening a file download directly;
	 * instead, they must first save the file locally.
	 *
	 * @since 24.1
	 */
	 ...
	 * X-DNS-Prefetch-Control}</a> header controls DNS prefetch behavior. Value can
	 * be "on" or "off". By default, DNS prefetching is "on" for HTTP pages and
	 * "off" for HTTPS pages.
	 */
	...
	/**
	 * The HTTP
	 * <a href="https://tools.ietf.org/html/draft-ietf-tokbind-https">{@code
