...
public class Assert {
	...
	public static void isTrue(boolean expression, String errorMsgTemplate, Object... params)
			throws IllegalArgumentException {
		if (false == expression) {
			throw new IllegalArgumentException(Strs.format(errorMsgTemplate, params));
		}
	}
	...
	public static <T> T notNull(T object, String errorMsgTemplate, Object... params) throws NullPointerException {
		if (object == null) {
			throw new NullPointerException(Strs.format(errorMsgTemplate, params));
		}
		return object;
	}
	 ...
	 *            参数
	 * @return 非空字符串
	 * @see Strs#isNotEmpty(CharSequence)
	 * @throws IllegalArgumentException
	 *             被检查字符串为空
	 */
	 ...
	 *            参数
	 * @return 非空字符串
	 * @see Strs#isNotBlank(CharSequence)
	 * @throws IllegalArgumentException
	 *             被检查字符串为空白
	 */
	...
	public static String notContain(String textToSearch, String substring, String errorMsgTemplate, Object... params)
			throws IllegalArgumentException {
		if (Strs.isNotEmpty(textToSearch) && Strs.isNotEmpty(substring) && textToSearch.contains(substring)) {
			throw new IllegalArgumentException(Strs.format(errorMsgTemplate, params));
		}
		return substring;
	}
