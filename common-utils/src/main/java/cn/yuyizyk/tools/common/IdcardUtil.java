...
import cn.yuyizyk.tools.lang.Nums;
...
public class IdcardUtil {
	...
	public static String convert15To18(String idCard) {
		...
		if (Nums.is(idCard)) {
			...
			Date birthDate = Dates.parse(birthday, "yyMMdd");
			// 获取出生年(完全表现形式,如：2010)
			int sYear = Dates.year(birthDate);
	...
	public static boolean isvalidCard15(String idCard) {
		...
		if (Validator.isNumber(idCard)) {
			...
			// 生日
			DateTime birthDate = Dates.parse(idCard.substring(6, 12), "yyMMdd");
	...
	public static DateTime getBirthDate(String idCard) {
		...
		return null == birthByIdCard ? null : Dates.parse(birthByIdCard, DatePattern.PURE_DATE_FORMAT);
	}
	...
	public static int getAgeByIdCard(String idCard) {
		return getAgeByIdCard(idCard, Dates.date());
	}
	...
	public static int getAgeByIdCard(String idCard, Date dateToCompare) {
		...
		return Dates.age(Dates.parse(birth, "yyyyMMdd"), dateToCompare);
	}
