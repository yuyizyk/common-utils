...
public class ReflectUtils {
	...
	public static <T> Constructor<T> getConstructor(Class<T> clazz, Class<?>... parameterTypes) {
		...
		for (Constructor<?> constructor : constructors) {
			...
			if (Clzs.isAllAssignableFrom(pts, parameterTypes)) {
	...
	public static Object getFieldValue(Object obj, String fieldName) {
		if (null == obj || Strs.isBlank(fieldName)) {
			return null;
		}
	...
	public static Object getFieldValue(Object obj, Field field) {
		...
		try {
			...
			throw Exceptions.box(e, "IllegalAccess for {}.{}", obj.getClass(), field.getName());
		}
		return result;
	}
	 ...
	 *            值，值类型必须与字段类型匹配，不会自动转换对象类型
	 * @throws UtilException
	 *             UtilException 包装IllegalAccessException异常
	 */
	 ...
	 * 
	 * @param obj
	 *            被查找的对象，如果为{@code null}返回{@code null}
	 * @param methodName
	 *            方法名，如果为空字符串返回{@code null}
	 * @param args
	 *            参数
	 * @return 方法
	 * @throws SecurityException
	...
	public static Method getMethodOfObj(Object obj, String methodName, Object... args) throws SecurityException {
		if (Objs.isEmpty(obj) || Strs.isBlank(methodName)) {
			return null;
		}
		return getMethod(obj.getClass(), methodName, Clzs.getClasses(args));
	}
	 ...
	 * 
	 * @param clazz
	 *            类，如果为{@code null}返回{@code null}
	 * @param methodName
	 *            方法名，如果为空字符串返回{@code null}
	 * @param paramTypes
	 *            参数类型，指定参数类型如果是方法的子类也算
	 * @return 方法
	 * @throws SecurityException
	 *             无权访问抛出异常
	 * @since 3.2.0
	...
	public static Method getMethod(Class<?> clazz, boolean ignoreCase, String methodName, Class<?>... paramTypes)
			throws SecurityException {
		if (null == clazz || Strs.isBlank(methodName)) {
			return null;
		}
		...
		if (!Objs.isEmpty(methods)) {
			for (Method method : methods) {
				if (Strs.equals(methodName, method.getName(), ignoreCase)) {
	 ...
	 *            返回对象类型
	 * @param obj
	 *            对象，如果执行静态方法，此值为<code>null</code>
	 * @param method
	 *            方法（对象方法或static方法都可）
	 * @param args
	 *            参数对象
	...
	public static <T> T invoke(Object obj, Method method, Object... args) {
		...
		try {
			return (T) method.invoke(Clzs.isStatic(method) ? null : obj, args);
		} catch (Exception e) {
	...
	public static <T> T invoke(Object obj, String methodName, Object... args) {
		...
		Assert.isNull(method, "No such method: [{}]", methodName);
